...
from app.core.types.bunch import bunch, null_bunch
...
class TestCase(unittest.TestCase):
    ...
    def test_it_returns_missing_reading_unknown_key(self):
    ...
    def test_it_raises_an_creating_with_a_key_that_is_a_keyword(self):
        with self.assertRaises(ValueError) as err_ctx:
            bunch({'if': 1})
